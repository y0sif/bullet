/// Phase B variant B-o2 — B-spline KAN with SCReLU base, SPLINE_ORDER=2.
///
/// Quadratic basis (vs baseline cubic) — quantizes more cleanly,
/// fewer parameters per edge.
use bullet_lib::{
    game::{
        formats::sfbinpack::{
            TrainingDataEntry,
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "kan-variant-b-o2".to_string(),

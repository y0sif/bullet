/// Phase B variant B-g3 — B-spline KAN with SCReLU base, GRID_SIZE=3.
///
/// Reduced grid capacity (3 intervals instead of baseline 5).
use bullet_lib::{
    game::{
        formats::sfbinpack::{
            TrainingDataEntry,
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "kan-variant-b-g3".to_string(),

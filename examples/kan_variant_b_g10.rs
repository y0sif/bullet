/// Phase B variant B-g10 — B-spline KAN with SCReLU base, GRID_SIZE=10.
///
/// Too-many-knots stress test (10 intervals vs baseline 5).
use bullet_lib::{
    game::{
        formats::sfbinpack::{
            TrainingDataEntry,
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "kan-variant-b-g10".to_string(),

/// Phase A variant B — B-spline KAN with SCReLU base.
///
/// Same as variant A except the base path uses SCReLU instead of SiLU.
/// Matches the Stockfish lineage and may quantize more cleanly downstream.
use bullet_lib::{
    game::{
        formats::sfbinpack::{
            TrainingDataEntry,
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "kan-variant-b".to_string(),

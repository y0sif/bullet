/// Phase B variant B-o4 — B-spline KAN with SCReLU base, SPLINE_ORDER=4.
///
/// Quartic basis (vs baseline cubic) — smoother activations,
/// more parameters per edge, slower.
use bullet_lib::{
    game::{
        formats::sfbinpack::{
            TrainingDataEntry,
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "kan-variant-b-o4".to_string(),
